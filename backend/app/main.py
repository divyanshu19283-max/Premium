...
from app.models.freight import FreightRate, ModelRun
from app.routes import chat, data, decision, forecast, maritime
from app.services.reference_data import seed_reference_data
from app.ml.train import HORIZONS, MODEL_DIR
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        # ----------------------------------------------------
        "https://premium-4v3ssz01z-divyanshu19283-maxs-projects.vercel.app",
